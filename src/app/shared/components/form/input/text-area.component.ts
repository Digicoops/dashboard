...
export class TextAreaComponent {
  ...
  get textareaClasses(): string {
    ...
    if (this.disabled) {
      ...
      base += 'bg-transparent text-gray-900 dark:text-gray-300 text-gray-900 border-gray-300 focus:border-success-300 focus:ring-3 focus:ring-success-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-success-800';
    }
    return base;
  }
}
